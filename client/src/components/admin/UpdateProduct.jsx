...
import { updateProduct, getProductDetails } from '../../store/actions/productActions'
...
const Dashboard = ({ match, history }) => {
    ...
    const { loading, error: updateError, isUpdated } = useSelector(state => state.productAdmin)
    ...
    useEffect(() => {
        ...
        if (product && product._id !== productId) {
            ...
            setContentText(product.contentText)
        ...
        if (isUpdated) {
            ...
            // dispatch({ type: actionTypes.P })
            history.push('/admin/products')
        }

    }, [error, dispatch, alert, isUpdated, history, updateError, productId, product])
            ...
            <div className="row">
                ...
                <div className="col-12 col-md-10">
                    <div className="container container-fluid">
                        <div className="wrapper-new-pr my-5">
                            {loading ? <Loader /> : (
                                <form className="shadow-lg"
                                    onSubmit={submitHandler}
                                    encType='multipart/form-data'>
                                    <h1 className="mb-4"><b>Update Product</b></h1>
